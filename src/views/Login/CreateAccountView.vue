<template>
    <div class="mt-[4%] w-full flex flex-col justify-center items-center">
        ...
        <div class="flex flex-col justify-center items-center font-poppins gap-1 rounded-xl w-11/12 p-1 animate-fade">
            ...
            <input v-model="email" class="border-b border-[#4f9ad8] w-full text-lg text-center h-12 focus:outline-none focus:border-sky-700 mb-4" type="email" name="email" placeholder="Enter your email" required>
            <label class="self-start font-medium text-lg" for="password">Password</label>
            <input v-model="password" class="border-b border-[#4f9ad8] w-full text-lg text-center h-12 focus:outline-none focus:border-sky-700 mb-4" type="password" name="password" placeholder="Set a password for your account">
            <label class="self-start font-medium text-lg" for="confirm-password">Confirm Password</label>
            <input v-model="confirmPassword" class="border-b border-[#4f9ad8] w-full text-lg text-center h-12 focus:outline-none focus:border-sky-700 mb-4" type="password" name="confirm-password" placeholder="Confirm your password">
