<template>
    <div class="pt-[57px]  overflow-x-hidden animate-fade-left animate-duration-500 h-dvh pattern-dots pattern-sky-200 pattern-bg-slate-100 pattern-size-6 pattern-opacity-80"> 
        ...
        <section class="flex flex-col items-center">
            ...
            <div class="box-border fixed flex items-center justify-around w-full p-1 bg-slate-100 bottom-1 rounded-tl-md rounded-tr-md">
                ...
                <v-icon @click="sendMessage" class="cursor-pointer" name="pr-send" scale="2.3" color="#1b98ff"/>
            </div>
        </section>
    </div>
</template>
